...
| ASM, Rust, computer vision, SLAM,  ;
 ...
 !                                .'
.` ARMED w/ BSc & MSc CompSci, MBA, `.
| MSc AI/DL, BSc CompSci,            ;
 !                                    |
...
P.S. No recruiters, no cryptobros/web3,
     no front-end webdev, no doctors, no
     lawyers, no priests.
```
